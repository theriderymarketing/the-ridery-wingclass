      ...
      <aside className="w-64 bg-white text-gray-900 flex flex-col hidden md:flex fixed h-full z-20 border-r border-gray-200">
        ...
        <div className="px-6 py-4">
          ...
          <nav className="space-y-1.5">
            <Link href="/admin" className="flex items-center gap-3 px-4 py-3 bg-orange-50 text-orange-600 rounded-lg font-semibold transition-all">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
              Planning Général
            </Link>
            <Link href="/admin/instructors" className="flex items-center gap-3 px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg font-medium transition-all group">
        ...
        <div className="px-6 py-4 mt-auto">
          ...
          <nav>
            <Link href="/admin/settings" className="flex items-center gap-3 px-4 py-3 text-gray-500 hover:text-gray-900 hover:bg-gray-50 rounded-lg font-medium transition-all group">
